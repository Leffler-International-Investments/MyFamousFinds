...
export default function ManagementUpsDiagnosticsPage() {
  ...
  async function runDiagnostics() {
    ...
    try {
      ...
      // Use the same diagnostics API — it already supports management auth
      const res = await fetch("/api/ups/order-diagnostics", {
        method: "POST",
  ...
  return (
    <>
      <Head>
        <title>UPS Label Diagnostics — Management</title>
      </Head>
      ...
      <div className="dashboard-page">
        ...
        <main className="page-wrap">
          <div className="back-link">
            <Link href="/management/dashboard">&larr; Back to Management Dashboard</Link>
          </div>
          ...
          <section className="card">
            ...
            <p className="muted">
              ...
              Works for both real and paper-trade orders.
            </p>
          ...
          {result && (
            <>
              <section className="card">
                ...
                {result.order.paperTrade && (
                  <div className="paper-badge">PAPER TRADE ORDER</div>
                )}
              ...
              <section className="card">
                ...
                <div className="links-row">
                  <Link href={`/management/order-roadmap?orderId=${result.order.id}`} className="quick-link">
                    Order Roadmap
                  </Link>
                  <Link href="/management/purchases" className="quick-link">
                    Purchases
                  </Link>
                  <Link href="/management/paper-trade" className="quick-link">
                    Paper Trade
                  </Link>
                  <Link href="/management/payouts" className="quick-link">
                    Payouts
                  </Link>
                </div>
              </section>
      ...
      <style jsx>{`
        ...
        .paper-badge { display: inline-block; background: #b45309; color: #fff; font-size: 11px; font-weight: 800; padding: 4px 10px; border-radius: 999px; letter-spacing: 0.1em; margin-bottom: 10px; }
        ...
        .quick-link { display: inline-flex; padding: 8px 14px; border-radius: 8px; border: 1px solid #e5e7eb; background: #f9fafb; font-size: 13px; font-weight: 600; color: #111827; text-decoration: none; }
