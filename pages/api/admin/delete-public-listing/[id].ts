...
// Deletes a listing: hard-deletes from BOTH Admin and Client Firestore AND marks
// as soft-deleted so it disappears from ALL pages (homepage, search, store, etc.)
