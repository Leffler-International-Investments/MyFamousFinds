...
// TYPO FIX: e.target.value is now correct.
    ...
    <div>
      ...
      <div className="mt-1 flex rounded-md border border-neutral-700 bg-black/40">
        <input
          ...
          className="flex-1 rounded-l-md border-0 bg-transparent px-3 py-2 text-sm text-gray-100 focus:outline-none focus:ring-0"
        />
        <button
          type="button"
