    ...
    <div className="overlay" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <p className="subtext">Sign in or create an account to continue</p>
          ...
          {mode === "choose" && (
            <>
              ...
              <button className="social-btn email-btn" onClick={() => setMode("email-signin")} disabled={loading}>
          ...
          {mode === "email-signin" && (
            <form onSubmit={handleEmailSignIn} className="email-form">
              ...
              <p className="switch-text">
                ...
                <button type="button" className="link-btn" onClick={() => { setMode("email-signup"); setError(""); }}>
                  Sign up
                </button>
              </p>
              <button type="button" className="link-btn back-link" onClick={resetToChoose}>
                Back to all options
              </button>
            </form>
          )}
          ...
          {mode === "email-signup" && (
            <form onSubmit={handleEmailSignUp} className="email-form">
              ...
              <p className="switch-text">
                ...
                <button type="button" className="link-btn" onClick={() => { setMode("email-signin"); setError(""); }}>
                  Sign in
                </button>
              </p>
              <button type="button" className="link-btn back-link" onClick={resetToChoose}>
