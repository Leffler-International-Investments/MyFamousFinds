...
export default function PasswordInput({
  ...
  const strength = showStrength ? computeStrength(value) : { label: "", level: "" as StrengthLevel };
  ...
  return (
    <div className="auth-field">
      ...
      {showStrength && strength.label && (
        <p className={`password-strength${strength.level ? ` password-strength-${strength.level}` : ""}`}>
          {strength.label}
        </p>
      )}
    </div>
