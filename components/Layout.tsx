...
export default function Layout({
  title = "FamousFinds — US fashion marketplace",
  children,
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Head>
        ...
        <meta
          name="description"
          content="US-only marketplace for new & pre-loved fashion, bags, jewelry, shoes, and party dresses."
        />
      ...
      <footer className="border-t text-sm text-center p-6">
        © {new Date().getFullYear()} FamousFinds • US-only
      </footer>
    </div>
  );
}
